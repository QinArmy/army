...
public class ChinaRegion<T extends ChinaRegion<T>> {
    ...
    /**
     *<p>Due to ChinaRegion contain generics,so provide static constructor method for army session query api.
     */
    ...
    /**
     *<p>Due to ChinaRegion contain generics,so provide static class for army session query api.
     */
