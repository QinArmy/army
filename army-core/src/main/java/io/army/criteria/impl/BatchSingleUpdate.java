...
abstract class BatchSingleUpdate<T extends IDomain, C, WR, WA, AR, SR, BR> extends QueryDmlStatement<C, WR, WA, AR>
        implements Update, Update.UpdateSpec, Update.BatchSingleSetClause<T, C, SR>,
        Statement.BatchParamClause<C, BR>, _SingleUpdate, _BatchSingleUpdate {
    ...
    BatchSingleUpdate(@Nullable C criteria) {
        super(criteria);
    ...
    @Override
    public final SR set(List<FieldMeta<? super T, ?>> fieldList) {
        if (fieldList.size() == 0) {
    ...
    @Override
    public final <F> SR set(FieldMeta<? super T, F> field, Expression<F> value) {
    ...
    @Override
    public final <F> SR set(FieldMeta<? super T, F> field) {
        return this.set(field, SQLs.namedParam(field));
    }

    @Override
    public final <F> SR setNull(FieldMeta<? super T, F> field) {
        return this.set(field, SQLs.nullWord());
    }

    @Override
    public final <F> SR setDefault(FieldMeta<? super T, F> field) {
        return this.set(field, SQLs.defaultWord());
    }

    @Override
    public final <F extends Number> SR setPlus(FieldMeta<? super T, F> field) {
        return this.set(field, field.plus(SQLs.nonNullNamedParam(field)));
    }

    @Override
    public final <F extends Number> SR setMinus(FieldMeta<? super T, F> field) {
        return this.set(field, field.minus(SQLs.nonNullNamedParam(field)));
    }

    @Override
    public final <F extends Number> SR setMultiply(FieldMeta<? super T, F> field) {
        return this.set(field, field.multiply(SQLs.nonNullNamedParam(field)));
    }

    @Override
    public final <F extends Number> SR setDivide(FieldMeta<? super T, F> field) {
        return this.set(field, field.divide(SQLs.nonNullNamedParam(field)));
    }

    @Override
    public <F extends Number> SR setMod(FieldMeta<? super T, F> field) {
        return this.set(field, field.mod(SQLs.nonNullNamedParam(field)));
    }

    @Override
    public final SR ifSet(Function<C, List<FieldMeta<? super T, ?>>> function) {
    ...
    @Override
    public final <F> SR ifSet(Predicate<C> test, FieldMeta<? super T, F> field) {
    ...
    @Override
    public final <F> SR ifSet(FieldMeta<? super T, F> filed, Function<C, Expression<F>> function) {
