 ...
 *         <li>{@link JoinableUpdate}</li>
 *     </ul>
 * </p>
 */
@Deprecated
@SuppressWarnings("unchecked")
abstract class JoinableUpdate0<C, F extends DataField, SR, FT, FS, FP, FJ, JT, JS, JP, WR, WA, U extends DmlStatement.DmlUpdate>
    ...
    JoinableUpdate0(CriteriaContext context) {
        super(context);
        assert this instanceof JoinableUpdate;
    ...
    JoinableUpdate0(CriteriaContext context, ClauseCreator<FP, JT, JS, JP> clauseCreator) {
