...
abstract class StandardUnionQuery<C, Q extends Query> extends PartQuery<
    ...
    static <C, E> StandardUnionSpec<C, ColumnSubQuery<E>> bracketColumnSubQuery(ColumnSubQuery<E> subQuery, @Nullable C criteria) {
        subQuery.prepared();
        return new BracketColumnSubQuery<>(subQuery, criteria);
    }

    static <C, E> StandardUnionSpec<C, ColumnSubQuery<E>> unionColumnSubQuery(ColumnSubQuery<E> left, UnionType unionType
    ...
    private static abstract class AbstractUnionSelect<C> extends StandardUnionQuery<Select, C> implements Select {
        ...
        @Override
        final StandardQuery.StandardSelectClauseSpec<Select, C> asQueryAndQuery(final UnionType unionType) {
    ...
    private static abstract class AbstractUnionSubQuery<C> extends StandardUnionQuery<SubQuery, C> implements SubQuery {
        ...
        @Override
        final StandardQuery.StandardSelectClauseSpec<SubQuery, C> asQueryAndQuery(UnionType unionType) {
    ...
    private static abstract class AbstractUnionRowSubQuery<C> extends StandardUnionQuery<RowSubQuery, C>
        ...
        @Override
        final StandardQuery.StandardSelectClauseSpec<RowSubQuery, C> asQueryAndQuery(UnionType unionType) {
    ...
    private static abstract class AbstractUnionColumnSubQuery<E, C> extends StandardUnionQuery<ColumnSubQuery<E>, C>
        ...
        @Override
        final StandardQuery.StandardSelectClauseSpec<ColumnSubQuery<E>, C> asQueryAndQuery(UnionType unionType) {
    ...
    private static abstract class AbstractUnionScalarSubQuery<E, C> extends StandardUnionQuery<ScalarQueryExpression<E>, C>
        ...
        @Override
        final StandardUnionResultSpec<ScalarQueryExpression<E>, C> createUnionQuery(ScalarQueryExpression<E> left, UnionType unionType, ScalarQueryExpression<E> right) {
            return StandardUnionQuery.unionScalarSubQuery(left, unionType, right, this.criteria);
        }

        @Override
        final StandardQuery.StandardSelectClauseSpec<ScalarQueryExpression<E>, C> asQueryAndQuery(UnionType unionType) {
