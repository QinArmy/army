...
final class ValueInsertContext extends StatementContext implements _ValueInsertContext, InsertStmtParams {
    ...
    static ValueInsertContext nonChild(_Insert._DomainInsert insert, ArmyDialect dialect, Visible visible) {
        checkCommonExpMap(insert);
        return new ValueInsertContext(dialect, insert, visible);
    }

    static ValueInsertContext child(_Insert._DomainInsert insert, ArmyDialect dialect, Visible visible) {
        return new ValueInsertContext(insert, dialect, visible);
    }


    private static void checkCommonExpMap(_Insert._DomainInsert insert) {
     ...
     */
    private ValueInsertContext(ArmyDialect dialect, _Insert._DomainInsert stmt, Visible visible) {
     ...
     */
    private ValueInsertContext(_Insert._DomainInsert stmt, ArmyDialect dialect, Visible visible) {
