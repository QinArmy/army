...
class _StandardUpdateContext extends AbstractStandardDomainContext implements _UpdateContext {

    static _StandardUpdateContext build(_SingleUpdate update, Dialect dialect, final Visible visible) {
        ...
        return new _StandardUpdateContext(dialect, visible
                , tableContext
                , tableMeta
                , tableMeta
    ...
    static _StandardUpdateContext buildParent(_SingleUpdate update, Dialect dialect, final Visible visible) {
    ...
    static _StandardUpdateContext buildChild(_SingleUpdate update, Dialect dialect, final Visible visible) {
        ChildTableMeta<?> childMeta = (ChildTableMeta<?>) update.table();
        String primaryRouteSuffix = _TableRouteUtils.singleDmlPrimaryRouteSuffix(update, dialect);
    ...
    private _StandardUpdateContext(Dialect dialect, Visible visible, TablesContext tableContext
    ...
    private static final class DomainUpdateContext extends _StandardUpdateContext {
