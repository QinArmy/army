...
//            case MySQL -> _MySQLParserFactory.mysqlDialectParser(environment);
//            case PostgreSQL -> _PostgreDialectFactory.postgreDialectParser(environment);
//            case SQLite -> _SQLiteParserFactory.sqliteDialectParser(environment);
