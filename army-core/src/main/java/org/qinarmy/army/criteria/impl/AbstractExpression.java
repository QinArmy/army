...
import org.qinarmy.army.criteria.SubQuery;
 ...
 */
public abstract class AbstractExpression<E> implements Expression<E>, Selection<E> {

    protected String alias;


    @Override
    public Selection<E> as(String alias) {
        this.alias = alias;
        return this;
    }
