...
import org.qinarmy.army.annotation.Index;
...
public final class DefaultTable<T extends IDomain> implements TableMeta<T> {
    ...
    public DefaultTable(Class<T> entityClass) throws MetaException {
        ...
        try {
            org.qinarmy.army.annotation.Table tableMeta = MetaUtils.tableMeta(entityClass);
    ...
    private Pair<List<String>, List<String>> crateIndexNames(org.qinarmy.army.annotation.Table tableMeta) {
