...
public class MappingUtilsTests {
    ...
    public void bitwiseToString() {
        ...
        String bitStr;
        bitStr = _MappingUtils.bitwiseToString(BitSetType.INSTANCE, bitSet, AbstractMappingType.PARAM_ERROR_HANDLER);
    ...
    public void bitwiseToLong() {
        ...
        for (long word : words) {
            ...
            paramValue = _MappingUtils.bitwiseToLong(BitSetType.INSTANCE, bitSet.toByteArray(), AbstractMappingType.PARAM_ERROR_HANDLER);
