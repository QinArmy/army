...
abstract class MySQL57SubQueries<Q extends MySQL57SubQuery, C> extends MySQL57PartQuery<Q, C>
    ...
    private static final class MySQL57ScalarSubQueryAdaptor<E, C> extends OperationExpression<E>
        ...
        @Override
        public final StandardUnionResultSpec<MySQL57ScalarSubQuery<E>, C> bracketsQuery() {
            return ComposeQueries.brackets(this.actualSelect.criteria, asQuery());
        }

        @Override
        public final StandardUnionResultSpec<MySQL57ScalarSubQuery<E>, C> union(Function<C, MySQL57ScalarSubQuery<E>> function) {
            return ComposeQueries.compose(this.actualSelect.criteria, asQuery(), UnionType.UNION, function);
        }

        @Override
        public final StandardUnionResultSpec<MySQL57ScalarSubQuery<E>, C> unionAll(Function<C, MySQL57ScalarSubQuery<E>> function) {
            return ComposeQueries.compose(this.actualSelect.criteria, asQuery(), UnionType.UNION_ALL, function);
        }

        @Override
        public final StandardUnionResultSpec<MySQL57ScalarSubQuery<E>, C> unionDistinct(Function<C, MySQL57ScalarSubQuery<E>> function) {
