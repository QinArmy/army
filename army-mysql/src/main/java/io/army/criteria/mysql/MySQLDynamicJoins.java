...
abstract class MySQLDynamicJoins extends JoinableClause.DynamicJoinableBlock<
    ...
    @Override
    protected final MySQLQuery._DynamicIndexHintJoinClause onFromTable(
    ...
    @Override
    protected final Statement._AsClause<MySQLQuery._DynamicJoinSpec> onFromDerived(
    ...
    @Override
    protected final MySQLQuery._DynamicJoinSpec onFromCte(
    ...
    @Override
    protected final MySQLQuery._DynamicIndexHintOnClause onJoinTable(
            _JoinType joinType, @Nullable SQLs.TableModifier modifier, TableMeta<?> table, String alias) {
    ...
    @Override
    protected final Statement._AsParensOnClause<MySQLStatement._DynamicJoinSpec> onJoinDerived(
            _JoinType joinType, @Nullable SQLs.DerivedModifier modifier, DerivedTable table) {
        return alias -> {
            final DynamicDerivedBlock block;
            block = new DynamicDerivedBlock(this.context, this.blockConsumer, joinType, modifier, table, alias);
    ...
    @Override
    protected final Statement._OnClause<MySQLQuery._DynamicJoinSpec> onJoinCte(
            _JoinType joinType, @Nullable SQLs.DerivedModifier modifier, _Cte cteItem, String alias) {
        final DynamicCteBlock block;
        block = new DynamicCteBlock(this.context, this.blockConsumer, joinType, cteItem, alias);
        this.blockConsumer.accept(block);
    ...
    private static final class MySQLJoinBuilder extends JoinableClause.DynamicBuilderSupport<
        ...
        @Override
        protected MySQLQuery._DynamicIndexHintOnClause onTable(
        ...
        @Override
        protected Statement._AsClause<Statement._OnClause<MySQLQuery._DynamicJoinSpec>> onDerived(
        ...
        @Override
        protected Statement._OnClause<MySQLQuery._DynamicJoinSpec> onCte(_Cte cteItem, String alias) {
            final DynamicCteBlock block;
    ...
    private static final class MySQLCrossJoinBuilder extends JoinableClause.DynamicBuilderSupport<
        ...
        @Override
        protected MySQLQuery._DynamicIndexHintJoinClause onTable(
                @Nullable SQLs.TableModifier modifier, TableMeta<?> table, String tableAlias) {
            final FromClauseTableBlock block;
        ...
        @Override
        protected Statement._AsClause<MySQLQuery._DynamicJoinSpec> onDerived(
                @Nullable SQLs.DerivedModifier modifier, DerivedTable table) {
            return alias -> {
                final DynamicDerivedBlock block;
                block = new DynamicDerivedBlock(this.context, this.blockConsumer, this.joinType, modifier, table, alias);
        ...
        @Override
        protected MySQLQuery._DynamicJoinSpec onCte(_Cte cteItem, String alias) {
            final DynamicCteBlock block;
            block = new DynamicCteBlock(this.context, this.blockConsumer, this.joinType, cteItem, alias);
            this.blockConsumer.accept(block);
            return block;
