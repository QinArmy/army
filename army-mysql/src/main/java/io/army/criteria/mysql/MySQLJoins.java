...
public interface MySQLJoins extends Statement.JoinBuilder {
    ...
    <T extends DerivedTable> Statement._AsClause<Statement._OnClause<MySQLQuery._DynamicJoinSpec>> tabular(Supplier<T> supplier);

    <T extends DerivedTable> Statement._AsClause<Statement._OnClause<MySQLQuery._DynamicJoinSpec>> tabular(Query.DerivedModifier modifier
            , Supplier<T> supplier);
