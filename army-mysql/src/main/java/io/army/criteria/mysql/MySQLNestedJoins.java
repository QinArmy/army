...
final class MySQLNestedJoins<I extends Item> extends JoinableClause.NestedLeftParenClause<
    ...
    @Override
    protected MySQLStatement._NestedIndexHintJoinSpec<I> onLeftTable(
    ...
    @Override
    protected Statement._AsClause<MySQLStatement._NestedLeftParensJoinSpec<I>> onLeftDerived(
    ...
    @Override
    protected MySQLStatement._MySQLNestedJoinClause<I> onLeftCte(_Cte cteItem, String alias) {
    ...
    private static class MySQLNestedBlock<I extends Item>
        ...
        @Override
        protected final MySQLQuery._NestedIndexHintCrossSpec<I> onFromTable(
        ...
        @Override
        protected final Statement._AsClause<MySQLStatement._NestedParenCrossSpec<I>> onFromDerived(
        ...
        @Override
        protected final MySQLQuery._NestedJoinSpec<I> onFromCte(
        ...
        @Override
        protected final MySQLQuery._NestedIndexHintOnSpec<I> onJoinTable(
                _JoinType joinType, @Nullable SQLs.TableModifier modifier, TableMeta<?> table, String alias) {
        ...
        @Override
        protected final Statement._AsClause<MySQLStatement._NestedParenOnSpec<I>> onJoinDerived(
                _JoinType joinType, @Nullable SQLs.DerivedModifier modifier, DerivedTable table) {
            return alias -> {
        ...
        @Override
        protected final MySQLQuery._NestedOnSpec<I> onJoinCte(
                _JoinType joinType, @Nullable SQLs.DerivedModifier modifier, _Cte cteItem, String alias) {
            final MySQLNestedBlock<I> block;
