...
abstract class PostgreDateTimeFunctions extends PostgreStringFunctions {
    ...
    public static SimpleExpression clockTimestamp() {
        return LiteralFunctions.zeroArgFunc("CLOCK_TIMESTAMP", OffsetDateTimeType.INSTANCE);
    }
    ...
    public static SimpleExpression currentTime(Expression integer) {
        return LiteralFunctions.oneArgFunc("CURRENT_TIME", integer, OffsetTimeType.INSTANCE);
    }
    ...
    public static SimpleExpression currentTimestamp(Expression integer) {
        return LiteralFunctions.oneArgFunc("CURRENT_TIMESTAMP", integer, OffsetDateTimeType.INSTANCE);
    }
    ...
    public static SimpleExpression dateBin(Expression interval, Expression timestamp1, Expression timestamp2) {
        return LiteralFunctions.threeArgFunc("DATE_BIN", interval, timestamp1, timestamp2, LocalDateTimeType.INSTANCE);
    }
