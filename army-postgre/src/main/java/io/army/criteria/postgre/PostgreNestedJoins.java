...
final class PostgreNestedJoins<I extends Item> extends JoinableClause.NestedLeftParenClause<
    ...
    @Override
    protected PostgreStatement._NestedTableSampleJoinSpec<I> onLeftTable(
    ...
    @Override
    protected Statement._AsClause<PostgreStatement._NestedParensJoinSpec<I>> onLeftDerived(
    ...
    @Override
    protected PostgreStatement._PostgreNestedJoinClause<I> onLeftCte(_Cte cteItem, String alias) {
    ...
    @Override
    protected PostgreStatement._FuncColumnDefinitionAsClause<PostgreStatement._PostgreNestedJoinClause<I>> onLeftUndoneFunc(
