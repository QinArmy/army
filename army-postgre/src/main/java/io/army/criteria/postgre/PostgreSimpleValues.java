...
import io.army.criteria.postgre.inner._PostgreValues;
...
abstract class PostgreSimpleValues<I extends Item> extends SimpleValues<
    ...
    @Override
    protected final String columnAlias(int columnIndex) {
    ...
    private static final class SimplePrimaryValues<I extends Item> extends PostgreSimpleValues<I>
        ...
        @Override
        protected I onAsValues() {
            return this.function.apply(this);
        }

        @Override
        protected _QueryWithComplexSpec<I> createUnionValues(final _UnionType unionType) {
    ...
    private static final class BracketValues<I extends Item> extends PostgreBracketValues<I>
        ...
        @Override
        protected _QueryWithComplexSpec<I> createUnionRowSet(final _UnionType unionType) {
            final Function<RowSet, I> unionFun;
