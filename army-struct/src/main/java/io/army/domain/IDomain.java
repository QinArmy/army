...
public interface IDomain {
    ...
    IDomain setVisible(Boolean visible);

    Integer getVersion();

    IDomain setVersion(Integer version);

    LocalDateTime getCreateTime();

    IDomain setCreateTime(LocalDateTime createTime);

    LocalDateTime getUpdateTime();

    IDomain setUpdateTime(LocalDateTime updateTime);
